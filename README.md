...
> `https://github.com/eedmond/kickstart.nvim.git`
...
```
git clone git@github.com/eedmond/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone git@github.com/eedmond/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
